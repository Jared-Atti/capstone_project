...
# timeline.pack(side=tk.TOP, expand=False)
# lifeForms.pack(side=tk.TOP, expand=False)
# visuals.pack(side=tk.TOP, expand=False)
# createLabel.pack(side=tk.TOP, expand=False)
# time.pack(side=tk.TOP, expand=True)
# timeline.pack(side=tk.TOP, fill=tk.BOTH, expand=True)
# lifeForms.pack(side=tk.TOP, fill=tk.BOTH, expand=True)
# visuals.pack(side=tk.TOP, fill=tk.BOTH, expand=True)
# createLabel.pack(side=tk.TOP, fill=tk.BOTH, expand=True)
# time.pack(side=tk.TOP, fill=tk.BOTH, expand=True)
...
#     canvas.itemconfig(canvas.find_withtag("mainframe"), width=event.width)
