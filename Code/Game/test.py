...
timeline = Frame(main_Frame, relief = RAISED, bd = 5, bg = "white", height = 90, width = 2000, background='black')

lifeForms = Frame(main_Frame, relief= RAISED, bd = 5, bg = "purple", height = 40, width = 2000)

visuals = Frame(main_Frame, relief = RAISED, bd = 5, bg = "yellow", height = 450, width = 450)

createLabel = Frame(main_Frame, bg = "orange", height = 40, width = 100)

time = Frame(main_Frame, relief = RAISED, bd = 5, bg = "pink", height = 40, width = 175)
...
def check_milestones():
    ...
    if game.energy >= 1 and resourcesF == None:
        ...
        resourcesF = Frame(main_Frame, relief = RAISED, bd = 5, bg = "red", height = RESOURCE_FRAME_HEIGHT, width = LEFT_COLUMN_WIDTH)
    ...
    if game.energy >= 5 and upgradesF == None:
        ...
        upgradesF = Frame (main_Frame, relief = RAISED, bd = 5, bg = "teal", height = UPGRADE_FRAME_HEIGHT, width = MIDDLE_COLUMN_WIDTH)
    ...
    if game.productionFrame == False and productionF == None and u1_GC.active == 2:
        ...
        productionF = Frame(main_Frame, relief = RAISED, bd = 5, bg = "green", height = PRODUCTION_FRAME_HEIGHT, width = LEFT_COLUMN_WIDTH)
    ...
    if temporalF == None and u3_TM.active == 2:
        ...
        global respecBut
        temporalF = Frame(main_Frame, relief = RAISED, bd = 5, bg = "cyan", height = TEMPORAL_FRAME_HEIGHT, width = MIDDLE_COLUMN_WIDTH)
